...
# So we first we code Hong Kong to not have an astrix and me we code Western 
...
# This has bilateral trade between all countries. The data is very difficult to 
# download online, so it took me an entire day to download this. The way that 
...
# turns that XML data set into a dataframe so, I basically do copied this code 
